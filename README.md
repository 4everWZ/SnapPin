...
SnapPin is a lightweight Windows screenshot and pin tool, built to match reference-style workflows.
...
In progress:
- Full reference-level pin behavior parity
...
The old specification tree was replaced with a compact reference app-aligned spec set:
