...
- Capture-context mark baseline: select, rectangle, ellipse, straight line, arrow, serial number with direct numeric entry and `+`/`-` adjustment, mosaic and blur with wheel strength, basic whole-object/path-segment eraser, basic freehand highlighter, basic rectangular spotlight, basic multi-click polyline with node drag / whole move, basic rectangular watermark, basic rectangular magnifier, pencil, text, undo/redo, delete, reselect, composed copy/save.
...
3. Implement remaining mark parity in small verified slices, starting with advanced polyline add/remove node controls or advanced effect controls.
...
- 2026-05-14 / mark polyline edit iteration - added basic Polyline node drag / whole move editing with composed-output regression coverage; advanced add/remove node controls remain unimplemented.
