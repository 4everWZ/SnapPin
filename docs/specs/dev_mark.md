...
- Line tools: straight line and basic multi-click polyline are implemented; basic polyline node drag and whole-polyline move are implemented, but advanced node add/remove/editing parity is not implemented.
