...
| Mark advanced tools | `mark/mark-pencil`, `mark/mosaic`, `mark/erase`, `mark/highlight`, `mark/watermark`, `mark/magnifier` | Partially implemented | Basic mosaic/blur with wheel strength, whole-object/path-segment eraser, freehand highlighter, rectangular spotlight, manually placed text watermark with direct text entry, and rectangular 2x magnifier exist; missing smart erase, full partial/reverse erasing, Auto Mosaic, synced mosaic operations, advanced blur/highlighter/spotlight modes, reference-style watermark presets/batch/centered workflow, and advanced magnifier controls | Phase 3 mark expansion |
